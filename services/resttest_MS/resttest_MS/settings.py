"""
Django settings for resttest_MS project.
...
SECRET_KEY = '6ft3r)@^%x_br_n7kk@kicwrm6^sgt93gls-w=qt=v979(pvg7'
...
WSGI_APPLICATION = 'resttest_MS.wsgi.application'
